...
const AddCar = () => {
    // 2. GET 'currency' FROM THE CONTEXT and REMOVE 'axios'
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // 3. This axios call will now work correctly
            ...
            toast.error(error.message); // Use toast.error for consistency
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className='px-4 py-10 md:px-10 flex-1'>
            <Title title='Add New Car' subtitle='Fill in details to add a new car for booking, including pricing, availability, and car specifications.' />
            <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    ...
                    <div className='flex flex-col w-full'>
                        {/* 4. This will now display correctly */}
                ...
                {/* car transmission fuel tyoe and seating capacity */}
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
                    <div className='flex flex-col w-full'>
